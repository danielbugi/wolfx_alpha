    ...
    def check_donchian_breakout(self, symbol: str, screening_date: str = None) -> Optional[Dict]:
        ...
        try:
            ...
            enhanced_signal = {
                ...
                'summary_text': self.get_summary_text(breakout_type, distance_to_high, distance_to_low, current_price, ml_result)
            }
        ...
        for i, symbol in enumerate(symbols, 1):
            try:
                ...
                if enhanced_signal:
                    ...
                    logger.info(f"Found {enhanced_signal['type']} for {symbol} at ${enhanced_signal['current_price']:.2f}{ml_info}")
        ...
        try:
            ...
            output_data = {
                ...
                'ai_insights': {
                    ...
                    'strong_buy_recommendations': [r for r in results if r.get('ml_trade_recommendation') == 'strong_buy'],
                    'strong_sell_recommendations': [r for r in results if r.get('ml_trade_recommendation') == 'strong_sell']
                },
                'top_signals': {
